...
- Public-facing release notes track iOS through 1.4.1 (released 13th May 2026, Home Screen quick actions + auto-detected receipt date). 1.4.0 entry (5th May 2026) remains below it. The `/downloads` Android APK route is intentionally not advertised on the home page — closed-beta only until the Play Store launch.
