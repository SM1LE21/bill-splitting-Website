...
- Bundle: Home First Load JS ~166 kB after the PostHog wrapper and the ProductFlow section; was ~161 kB right after the Remotion strip and ~222 kB before the Remotion strip. PostHog itself lazy-loads after consent.
