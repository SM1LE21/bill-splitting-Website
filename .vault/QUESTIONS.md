...
- [ ] 2026-04-30 — Once PostHog is live, should Google Analytics remain in production, or should GA be removed/downgraded to reduce duplicate analytics tooling?
- [ ] 2026-04-30 — Should production PostHog session replay be enabled (`NEXT_PUBLIC_POSTHOG_SESSION_REPLAY=true`), or should the website stay on explicit event tracking only?
