          ...
          >
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              >
                <Link
                  href="#"
                  className="rounded-full bg-white px-8 py-4 text-lg font-semibold text-gray-900 shadow-sm hover:bg-gray-100 transition-colors"
                >
                  Download for iOS
                </Link>
              </motion.div>
              ...
              >
                <Link
                  href="#"
                  className="rounded-full bg-primary px-8 py-4 text-lg font-semibold text-white shadow-sm hover:bg-primary/90 transition-colors"
                >
